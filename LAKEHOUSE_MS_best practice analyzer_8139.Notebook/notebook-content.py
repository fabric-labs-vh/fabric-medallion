...
dataset = "LAKEHOUSE_MS" # Enter the name or ID of the semantic model
workspace = "medallion_architecture" # Enter the workspace name or ID in which the semantic model exists
